      ...
      <div className="container">
        ...
        <div className="about-content">
          ...
          >
            <h3>My Story</h3>
            <p>
              I'm a passionate Software Engineer with a strong drive to create impactful web and mobile applications.
               What started as a curiosity for programming has evolved into a commitment to building clean, efficient, 
               and user-friendly solutions across platforms.
            </p>
            <p>
